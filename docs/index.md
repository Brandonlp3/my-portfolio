...
[![Resume](https://img.shields.io/badge/PDF-Resume-green?logo=adobeacrobatreader)](Brandon-Ps-Resume3.pdf){ target="_blank" }
...
| Tech Stack | Java, Python, C/C++, C#, TypeScript/React, Django/REST, SQL, PyTorch, NLP |
| Interests | Applied ML, Scalable Web Systems, Developer Experience, Assistive Tech |
...
## Technical Skills
**Languages:** Java, Python, C, C++, C#, HTML, CSS, JavaScript, React, TypeScript, SQL, Git  
**Frameworks / Tools:** PyTorch, SpaCy, NumPy, Pandas, Django, Django REST Framework, NLP, OOP, GitHub  
**Cloud / Infra Exposure:** VPC Networking, Cloud CDN, Load Balancers, Cloud Functions, Cloud Armor, Compute Engine  
**Product Strengths:** Rapid prototyping, API design, UI/UX iteration, AI-assisted workflows
...
## Resume
You can open the PDF directly here: [Download Resume (PDF)](Brandon-Ps-Resume3.pdf){ target="_blank" }  
